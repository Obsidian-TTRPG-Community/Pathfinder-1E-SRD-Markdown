...
tactics:
  ...
  - name: Base Statistics
    desc: "Without heroism and protection from arrows, the archer\u2019s base statistics are Senses Perception +12; Fort +5, Ref +7, Will +8; DR none; Melee +2 short sword +12/+7 (1d6+4/19-20); Ranged mwk composite longbow +16/+11 (1d8+5/\xd73); Skills Climb +8, Knowledge (arcana, nature) +7, Perception +12, Spellcraft +7 (+9 to identify magic item properties), Stealth +12, Swim +8."
