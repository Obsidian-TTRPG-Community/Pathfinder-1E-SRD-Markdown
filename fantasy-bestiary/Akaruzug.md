...
special_abilities:
  ...
  - name: Soul Shield (Ex)
    desc: "As long as an akaruzug is active, it gains bonus hit points equal to its Charisma modifier \xd7 its Hit Dice (80 hit points for a typical akaruzug), and gains a deflection bonus equal to its Charisma modifier to its Armor Class (+4 for a typical akaruzug)."
  - name: Soul Slave (Sp)
