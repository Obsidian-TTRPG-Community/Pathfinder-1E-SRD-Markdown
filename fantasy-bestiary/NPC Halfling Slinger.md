...
tactics:
  ...
  - name: Base Statistics
    desc: "Without bull's strength and heroism, the fighter's statistics are Senses Perception +3; Fort +9, Ref +9, Will +7; Melee +1 halfling sling staff +14/+9 (1d4+6/19-20) or short sword +12/+7 (1d4+2/19-20); Ranged +1 halfling sling staff +20 (1d6+6/19-20/\xd73); Str 12; CMB +9; CMD 24; Skills Acrobatics +5 (+1 when jumping), Climb +1, Perception +3, Ride +15, Survival +13."
